  ...
  <div style={{ background: "linear-gradient(180deg, rgba(20,20,30,0.05) 0%, rgba(20,30,45,0.35) 75%, rgba(15,20,30,0.55) 100%)" }} />
      ...
      >
        ...
        <section className="px-5 pb-14 pt-14 text-center sm:pt-20">
           {/* <span className="inline-flex items-center gap-2 rounded-full border border-white/25 bg-[#0B1B2E]/50 px-4 py-1.5 text-xs font-medium shadow-lg shadow-black/30 backdrop-blur-sm">
            <Sparkles className="h-3.5 w-3.5 text-[#F2A93B]" /> Discover Incredible India
          </span>  */}
            
            <h1 className="mx-auto mt-1 max-w-xl font-['Fraunces',Georgia,serif] text-4xl font-bold leading-[1.1] text-black drop-shadow-[0_2px_4px_rgba(0,0,0,0.9)] drop-shadow-[0_0_20px_rgba(0,0,0,0.55)] sm:text-5xl">
