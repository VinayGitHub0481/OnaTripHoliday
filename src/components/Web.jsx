...
/>
        ...
        <div className="mx-auto mt-5 flex max-w-lg flex-col items-center gap-3 text-center text-sm text-[#F6EFE1]/80 sm:flex-row sm:flex-wrap sm:justify-center sm:gap-x-8 sm:gap-y-3">
            <a
